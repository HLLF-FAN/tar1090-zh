...
function refreshCompanyList(){
	...
	for(i=0; i<companies.length; i++){
		...
		for(c=0; c<company_flights.length; c++){
			...
			outHTML += "<td colspan='2' style='padding-left: 5px;'><a href='https://flightadsb.variflight.com/tracker/" + company_flights[c][1].trim() + "' target='_blank'>" + company_flights[c][1].trim() + "</td>";
